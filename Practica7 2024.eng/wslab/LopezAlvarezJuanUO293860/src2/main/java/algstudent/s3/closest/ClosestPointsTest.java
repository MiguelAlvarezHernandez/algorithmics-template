...
public class ClosestPointsTest {
	...
	public void testCase02() {
		ClosestPoints closest = new ClosestPoints();
		closest.loadPoints("src/main/java/algstudent/s3/closest/case2.txt");
		closest.printPoints();
	...
	public void testCase03() {
		ClosestPoints closest = new ClosestPoints();
		closest.loadPoints("src/main/java/algstudent/s3/closest/case3.txt");
		closest.printPoints();
	...
	public void testCase04() {
		ClosestPoints closest = new ClosestPoints();
		closest.loadPoints("src/main/java/algstudent/s3/closest/case4.txt");
		closest.printPoints();
