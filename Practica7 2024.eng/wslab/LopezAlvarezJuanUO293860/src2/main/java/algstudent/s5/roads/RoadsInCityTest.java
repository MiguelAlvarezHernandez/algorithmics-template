...
public class RoadsInCityTest {
	...
	@Test
	public void testA() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case1.txt");
		assertEquals(2, result);
	}
	
	@Test
	public void testB() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case2.txt");
		assertEquals(252, result);
	}
	
	@Test
	public void testC() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case3.txt");
		assertEquals(0, result);
	}
	
	@Test
	public void testD() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case4.txt");
		assertEquals(6406484391866534976l, result);
	}
	
	@Test
	public void testE() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case5.txt");
		assertEquals(4, result);
	}

	@Test
	public void testF() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case6.txt");
		assertEquals(2, result);
	}
	
	@Test
	public void testG() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case7.txt");
		assertEquals(-1, result);
	}
	
	@Test
	public void testH() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case8.txt");
		assertEquals(-1, result);
	}
	
	@Test
	public void testI() {
		long result = executeFromFile("src/main/java/algstudent/s5/roads/case9.txt");
		assertEquals(-1, result);
	}
